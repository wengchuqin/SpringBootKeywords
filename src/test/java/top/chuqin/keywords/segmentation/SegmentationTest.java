package top.chuqin.keywords.segmentation;
...
public class SegmentationTest {
    ...
    @Test
    public void test2() {
        String str = "维基解密否认斯诺登接受委内瑞拉庇护庇护庇护庇护";
        Result result = ToAnalysis.parse(str);
        System.out.printf("没有词性的切分结果：\n%s\n", result.toStringWithOutNature());
        System.out.printf("有词性的切分结果：\n%s\n", result.toString());

        result.getTerms().forEach(new Consumer<Term>() {
            @Override
            public void accept(Term term) {
                System.out.println("--------");
                System.out.println(term);
                System.out.println(term.toValue());
                System.out.println(term.termNatures().allFreq);
            }
        });
    }
    ...
    public void 关键词摘取(){
        ...
        result.stream().forEach(new Consumer<Keyword>() {
            @Override
